                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full rounded-xl border px-4 py-3 transition-all focus:ring-2 focus:ring-blue-500/20 ${
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        onChange={handleInputChange}
                                        rows={5}
                                        className={`w-full resize-none rounded-xl border px-4 py-3 transition-all focus:ring-2 focus:ring-blue-500/20 ${
                                ...
                                <button
                                    type="submit"
                                    disabled={isSubmitting}
                                    className="w-full rounded-xl bg-blue-600 px-6 py-4 text-lg font-semibold text-white transition-all hover:scale-105 hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-50"
                                >
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-start space-x-4 p-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    <a href={`mailto:${contactInfo.email}`} className="text-blue-600 transition-colors hover:text-blue-800">
                                        {contactInfo.email}
                                    </a>
                        ...
                        <div className="rounded-xl border border-gray-200 bg-gray-50/50 p-6">
                            ...
                            <div className="flex space-x-4">
                                <a
                                    href="#"
                                    className="flex h-12 w-12 items-center justify-center rounded-xl bg-blue-600 text-white transition-all hover:scale-105 hover:bg-blue-700"
                                >
                                ...
                                <a
                                    href="#"
                                    className="flex h-12 w-12 items-center justify-center rounded-xl bg-blue-800 text-white transition-all hover:scale-105 hover:bg-blue-900"
                                >
                                    <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <a
                                    href="#"
                                    className="flex h-12 w-12 items-center justify-center rounded-xl bg-pink-600 text-white transition-all hover:scale-105 hover:bg-pink-700"
                                >
                                    <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">

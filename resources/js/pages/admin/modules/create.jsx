...
export default function CreateModule({ course, user }) {
    ...
    return (
        <AdminLayout user={user} currentPath={`/admin/courses/${course.id}/modules/create`}>
                ...
                <div className="bg-white shadow rounded-lg p-6">
                    <div className="mb-6">
                        ...
                        <p className="mt-2 text-gray-600">
                            Add a new module to <span className="font-semibold">{course.title}</span>
                        </p>
                    </div>

...
export default function CreateReproductiveHealthProtection({ user }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post('/admin/reproductive-health-protections');
    };

    return (
        <AdminLayout user={user} currentPath="/admin/reproductive-health-protections/create">
            <Head title="Create Reproductive Health Protection Method" />
            ...
            <div className="mx-auto max-w-4xl">
                ...
                <div className="rounded-lg bg-white p-6 shadow">
                    <div className="mb-6">
                        <h2 className="text-2xl font-bold text-gray-900">Create New Protection Method</h2>
                        <p className="mt-2 text-gray-600">Add a new reproductive health protection method to the platform</p>
                    </div>
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="space-y-2">
                                ...
                                {imagePreview && (
                                    <div className="mt-3">
                                        <p className="mb-2 text-sm text-gray-700">Image Preview:</p>
                                        <img src={imagePreview} alt="Preview" className="h-40 w-40 rounded-lg border border-gray-300 object-cover" />
                                    </div>
                                )}
                            </div>
                            <p className="mt-1 text-xs text-gray-500">Optional: Upload an image file (JPG, PNG, GIF, WebP - Max 5MB)</p>
                        </div>

...
export default function CreateLesson({ course, module, user }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(`/admin/courses/${course.id}/modules/${module.id}/lessons`);
    };

    return (
        <AdminLayout user={user} currentPath={`/admin/courses/${course.id}/modules/${module.id}/lessons/create`}>
